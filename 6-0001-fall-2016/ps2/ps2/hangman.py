...
def is_word_guessed(secret_word, letters_guessed):
    ...
    for i in secret_word:
        if i not in letters_guessed:
            return False
    return True# FILL IN YOUR CODE HERE AND DELETE "pass"
...
def get_guessed_word(secret_word, letters_guessed):
    ...
    for i in secret_word:
        if i in letters_guessed:
            ...
            a=a+"_ "# FILL IN YOUR CODE HERE AND DELETE "pass"
...
def get_available_letters(letters_guessed):
    ...
    for i in a:
        if i not in letters_guessed:
            b=b+i# FILL IN YOUR CODE HERE AND DELETE "pass"
    return b 
...
def hangman(secret_word):
    ...
    while guesses>0:
        print("-------------")
        print("You have",guesses,"quesses left.")
        print("Available letters:",get_available_letters(letters_guessed))
        a=input("Plesase guese a letter:")
        if str.isalpha(a):
            a=str.lower(a)
        if a not in get_available_letters(letters_guessed):
